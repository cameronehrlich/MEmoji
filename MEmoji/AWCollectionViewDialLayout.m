...
-(instancetype)initWithRadius:(CGFloat)radius andAngularSpacing:(CGFloat)spacing andCellSize:(CGSize)cell andAlignment:(WheelAlignmentType)alignment andItemHeight:(CGFloat)height andXOffset:(CGFloat)xOff
{
    if (self = [super init])
    {
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if( self.wheelType == WHEELALIGNMENTLEFT){
        ...
        scaleFactor = fmax(0.4, 1 - fabs( newIndex *0.40));
