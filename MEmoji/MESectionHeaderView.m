...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setBackgroundColor:[[MEModel mainColor] colorWithAlphaComponent:0.75]];
        ...
        [self.titleLabel setFont:[MEModel mainFontWithSize:12]];
        [self.titleLabel setNumberOfLines:1];
        [self.titleLabel setTextColor:[UIColor lightTextColor]];
        ...
        [self.purchaseButton setFrame:CGRectMake((frame.size.width/2) + (captureButtonDiameter/2),
                                                 ...
                                                 frame.size.height)];
        [self.purchaseButton.titleLabel setFont:[MEModel mainFontWithSize:12]];
        [self.purchaseButton setTitleColor:[UIColor lightTextColor] forState:UIControlStateNormal];
